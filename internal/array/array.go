...
func Generate() [10][2] string { //[10][2] lik bir dizi return eden fonksiyon yazdik 
	//random bir sekilde [10][2] dizi olusturduk ve bunu asagidaki fonksiyonu kullanarak randomdatalar ile doldurduk 
